...
namespace ZooOnlineStoreApi.Storage.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoryPetType",
                columns: table => new
                {
                    CategoriesId = table.Column<int>(type: "integer", nullable: false),
                    PetTypesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryPetType", x => new { x.CategoriesId, x.PetTypesId });
                    table.ForeignKey(
                        name: "FK_CategoryPetType_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryPetType_PetTypes_PetTypesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetTypeProduct", x => new { x.PetTypesId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_PetTypeProduct_PetTypes_PetTypesId",
                        column: x => x.PetTypesId,
                        principalTable: "PetTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PetTypeProduct_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryPetType_PetTypesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetTypeProduct_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_ImageName",
                table: "ProductImages",
                column: "ImageName",
                unique: true);
